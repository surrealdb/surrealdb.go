...
//   - RangeBeginInclusiveEndInclusive(1, None) → SurrealDB rejects NONE as a scalar record-id bound
//
...
//   - RangeBeginInclusiveEndInclusive(None, 10) → SurrealDB rejects NONE as a scalar record-id bound
//
